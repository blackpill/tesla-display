...
Il est fortement recommandé de définir le "Control on touchscreen"  option vérifiée. Lorsqu'il est vérifié, nous pouvons manipuler l'application Google Map directement sur l'écran tactile de Tesla.
...
## 5. Utilisation de l'application Google Map
<p style= "text-align: center;" >
<img src= "/assets/img/gmap-on-screen.jpg"  alt= "The screenshot of using Google Maps on Tesla's screen"  width= "540px" >
</p>
Maintenant, nous ouvrons l'application Google Map dans le téléphone, et nous pouvons voir que l'application Google Map est chassée sur l'écran tactile de Tesla.
Ensuite, nous pouvons définir la destination dans l'application Google Map.
...
Ensuite, nous pouvons entendre le son d'alerte de Google Map des haut-parleurs de Tesla.
