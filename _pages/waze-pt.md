...
Devemos definir o "Mirror Mode"  opção para "Image Mode"  Porque apenas "Image Mode"  Pode funcionar enquanto a Tesla está no modo de condução.
É fortemente recomendado definir o "Enable remote control"  opção verificada. Quando é verificado, podemos manipular oWaze aplicativo diretamente na tela sensível ao toque da Tesla.
...
## 5. Usando oWaze aplicativo
<p style= "text-align: center;" >
<img src= "/assets/img/waze-on-screen.jpg"  alt= "The screenshot of using Waze on Tesla's screen"  width= "540px" >
</p>
Agora, abrimos oWaze aplicativo no telefone, e podemos ver oWaze O aplicativo é lançado na tela sensível ao toque de Tesla.
Então podemos definir o destino noWaze aplicativo.
## 6. Sobre o som
Verifique se o Bluetooth está ativado no telefone e conectado ao Tesla EV.
Defina a fonte sonora de Tesla como Bluetooth.
Então podemos ouvir o som de alerta deWaze dos falantes de Tesla.
